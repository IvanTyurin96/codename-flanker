const Faq = () => {
  return (
    <div className="faq pt-3 pb-3">
      ...
      <p className="mt-2 mb-2">
        - Right now the mod includes Su-30 MKI,SM,MKM and MKA. Depending on which one you choose, you'll have different cockpit appearance(UFC, pilot-body) and
        Livery selection. At this moment, the mod does not include M2,MKK or any non-canard variant of Su-30.
      </p>
      ...
      <p className="mt-2 mb-2">
        ...
        properly. Ensure this is the path: "\Saved Games\DCS\Mods\aircraft". If "mods" & "aircraft" folders are missing, make them.
      </p>

      <h5 className="mt-3 mb-2">Question №5: Do I need to own any official module to play this?</h5>
      <p className="mt-2 mb-2">
        - Right now the mod uses Su-33 avionics for Air-to-Air and Su-25t avionics for Air-to-Ground. So you will need at least Su-33 if you want to do AA
        operations. FC3 will obviously also work.
      </p>

      <h5 className="mt-3 mb-2">Question №6: What if I don't have Su-33?</h5>
      <p className="mt-2 mb-2">
        - Then you can only play the Air-to-Ground version. If you choose Air-to-Air and start/join the mission, AI will take over. In order to play
        Air-to-Ground version, choose the aircraft with "AG" in their name.
      </p>

      <h5 className="mt-3 mb-2">Question №7: Can I use AA weapon with AG configuration and vise versa?</h5>
      <p className="mt-2 mb-2">
        - Guns, Rockets, Fox2 missiles and Dumb Bombs are indifferent to configuration. Every other weapon requires its corresponding configuration to be
        usable(AA weapons require AA and AG weapons require AG).
      </p>
      ...
      <p className="mt-2 mb-2">
        - At current state, the mod uses SFM (Standard Flight Model). EFM is currently work in progress and will be implemented in future update.
      </p>

      <h5 className="mt-3 mb-2">Question №10: Does it have ASM(Advanced System Modelling)?</h5>
      <p className="mt-2 mb-2">- Yes, the Module has ASM including clickable cockpit. We are implementing systems based on publicly available data.</p>

      <h5 className="mt-3 mb-2">Question №11: Does it have TVC(Thrust vector Control) ?</h5>
      <p className="mt-2 mb-2">
        - Yes, but this is a simplified implantation and a better one will come with EFMs. To learn how to use TVC, watch "Flight Control System" tutorial in{" "}
        <a className="link-primary" href="https://discord.com/channels/839196573228335185/935173821001003018">
          #tutorials
        </a>
      </p>
      ...
      <p className="mt-2 mb-2">
        - Multicrew is not fully implemented at the moment. It will be added in future. FC3 doesn't accept multicrew, it makes DCS crash. And without fc3, cant
        have weapons.
      </p>
      ...
      <p className="mt-2 mb-2">
        - Boresight is tied to Su33 so you need to use AA configuration to use that. Similarly, NVG is tied to Su-25t so you need to use AG configuration to use
        that. Refer to question 4.
      </p>
      ...
      <p className="mt-2 mb-2">- Enable cursor for clickable cockpit and then click on it from inside the cockpit. This also applies to Stick and Throttle.</p>
      ...
      <p className="mt-2 mb-2">
        - Remove all Su25 Engine sound files(5 in total) from inside this directory: "...\Saved Games\DCS\Mods\Resource\ECHO19_CORE\Sounds\Effects\Aircrafts\ ".
      </p>

      <h5 className="mt-3 mb-2">Question №19: Brahmos crashes into the ocean even when it (probably) has lock and is within firing range of the target.</h5>
      <p className="mt-2 mb-2">
        - You need to set Steer point with TV/laser ON, then fire, it will start to auto track at 30km from target. Do not use launch permission override.
      </p>
      ...
      <p className="mt-2 mb-2">
        - We all work in our free time which has no roadmap, so unfortunately the mod doesn't either. Same goes for EFM. However, whenever something is ready,
        we will mention it in{" "}
